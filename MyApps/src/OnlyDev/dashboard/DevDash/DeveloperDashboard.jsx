...
const DeveloperDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: 'team', label: 'Team Management', icon: Users, path: '/workers', badge: null },
    { id: 'resources', label: 'Resources', icon: Package, path: '/resources', badge: null },
    { id: 'analytics', label: 'Whiteboard', icon: BarChart3, path: '/doodles', badge: null },
    { id: 'budget', label: 'Budget Calculator', icon: DollarSign, path: '/Counter', badge: '2' },
    { id: 'quality', label: 'Quality Control', icon: Shield, path: '/quality', badge: null },
    { id: 'Task Manager', label: 'Task Manager', icon: Activity, path:'/jobtask' , badge: null },
