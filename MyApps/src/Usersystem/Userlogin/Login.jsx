...
const UserLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("http://localhost:5000/api/Uselogin", {
      method: "POST",
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mt-8">
          <div className="flex flex-col items-center mb-6">
            <h1
              className="text-3xl font-extrabold text-blue-600 mb-1"
          ...
          {message && (
            <p
              ...
              style={{ fontWeight: 600, textShadow: "0 1px 2px #fff" }}
            >
              {message}
            </p>
          )}
          ...
          <div
            className="mt-6 text-center text-gray-700 text-xs"
            style={{ textShadow: "0 1px 2px #fff" }}
          >
